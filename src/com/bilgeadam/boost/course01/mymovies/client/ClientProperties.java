...
public class ClientProperties {
	...
	private ClientProperties() {
		...
		props.setPropsFilePath("C:\\Users\\ACER\\Desktop\\Eclips%20File\\workspace\\MyMovieDB\\src\\com\\bilgeadam\\boost\\course01\\mymovies\\client\\", "client.properties");
	}
	...
	public String getDbURL() {
		...
		return props.getProperty("CONNECTOR_TYPE") + ":" + props.getProperty("DB_VENDOR") + "://" + props.getProperty("DB_SERVER") + ":" + props.getProperty("DB_PORT") + "/" + props.getProperty("DB_NAME") + "?user=" + props.getProperty("DB_USER")
