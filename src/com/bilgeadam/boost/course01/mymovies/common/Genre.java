...
public enum Genre implements Translatable {
	Documentary, Short, Animation, Comedy, Romance, Sport, News, Drama, Fantasy, Horror, Music, Musical, Thriller, Western, FilmNoir, Crime, War, Adventure, Family, History, Action, Mystery, Biography, SciFi, TalkShow, Adult, GameShow, Children,
	RealityTV, UNKOWN_TYPE, NOT_SPECIFIED;
